...
setup(name='{}-{}'.format(USERNAME, 'gym-super-mario'),
    version=VERSION,
    description='Gym User Env - 32 levels of Super Mario Bros (Fork From https://github.com/ppaquette/gym_super_mario )',
    url='https://github.com/rmxymh/gym_super_mario',
